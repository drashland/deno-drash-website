...
export const resource = {
  paths: ["/third-party-tutorials/databases/deno-mongo"],
  meta: {
    title: "deno_mongo",
    source_code_uri: "/third_party_tutorials/databases/deno_mongo"
  }
}
...
export default {
  data() {
    return {
      example_code: this.$app_data.example_code['/src/example_code/third_party_tutorials/databases/deno_mongo'],
      toc: {
        items: [
...
page-tutorial(
  ...
  div.row
    div.col
      ...
      p In this tutorial, you will create a very basic server that connects to a database using <a href="https://github.com/manyuanrong/deno_mongo" target="_BLANK">deno_mongo</a>.
      p This tutorial will be written using the following database:
      p
        code-block-slotted
          template(v-slot:title) database: deno
    ...
    div.col
      ...
      ol
        li Create your resource file.
          ...
          p Your resource will use deno_mongo to make a query to the database&ndash;getting all user records from the database.
